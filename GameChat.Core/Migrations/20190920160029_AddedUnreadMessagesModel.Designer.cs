...
namespace GameChat.Core.Migrations
{
    ...
    [Migration("20190920160029_AddedUnreadMessagesModel")]
    partial class AddedUnreadMessagesModel
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GameChat.Core.Models.Message", b =>
                {
                    ...
                    b.Property<bool>("ReadByAllParticipants");
            ...
            modelBuilder.Entity("GameChat.Core.Models.UnreadMessage", b =>
                {
                    b.Property<int>("MessageId");

                    b.Property<int>("ParticipantId");

                    b.HasKey("MessageId", "ParticipantId");
            ...
            modelBuilder.Entity("GameChat.Core.Models.UnreadMessage", b =>
                {
                    b.HasOne("GameChat.Core.Models.Message", "Message")
                        .WithMany("UsersThatHaventReadMessage")
